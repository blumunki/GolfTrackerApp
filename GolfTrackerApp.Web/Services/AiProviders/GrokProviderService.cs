...
namespace GolfTrackerApp.Web.Services.AiProviders
{
    ...
    /// </summary>
    public class GrokProviderService : IAiProviderService
    {
        private readonly HttpClient _httpClient;
        private readonly AiProviderConfig _config;
        private readonly ILogger<GrokProviderService> _logger;

        public string ProviderName => _config.Name;

        public GrokProviderService(
            HttpClient httpClient,
            AiProviderConfig config,
            ILogger<GrokProviderService> logger)
        {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                _logger.LogWarning("Grok API error {StatusCode}: {Body}", (int)response.StatusCode, errorBody);
