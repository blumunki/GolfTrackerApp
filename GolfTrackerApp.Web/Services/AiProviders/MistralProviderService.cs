...
namespace GolfTrackerApp.Web.Services.AiProviders
{
    ...
    /// </summary>
    public class MistralProviderService : IAiProviderService
    {
        private readonly HttpClient _httpClient;
        private readonly AiProviderConfig _config;
        private readonly ILogger<MistralProviderService> _logger;
        ...
        public MistralProviderService(
            ...
            ILogger<MistralProviderService> logger)
        {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                _logger.LogWarning("Mistral API error {StatusCode}: {Body}", (int)response.StatusCode, errorBody);
