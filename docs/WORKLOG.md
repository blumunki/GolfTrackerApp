...
| 1-1 | Create GolfTrackerApp.Core project + move Models/Services/Data (no rename) | 1 | In Progress | Codex | 2026-06-11 | Unblocked — 0-1..0-4 done. Move ProviderContexts.cs + both migration folders too |
