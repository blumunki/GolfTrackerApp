...
| P-2m | Mobile bottom-nav parity: Record Round as the centre action | polish | In Progress | Codex | 2026-07-11 | Adding Record Round as the prominent centre action in the MAUI bottom nav |
