...
| P-2m | Mobile bottom-nav parity: Record Round as the centre action | polish | Available | | 2026-06-15 | MAUI bottom nav in Components/App.razor; on-device test needed (run-android.sh/run-ios.sh) |
