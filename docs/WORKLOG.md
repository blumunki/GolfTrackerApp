...
| 2-11 | Wire orphaned AddEditTeeSetDialog + EditHoleTeesDialog into GolfCourseDetails (manual rating/slope entry) | 2 | In Progress | Claude | 2026-06-12 | Dialogs exist with rating/slope fields but are referenced by nothing — UI wiring only. Must land before user runs tee ratings sync (view/verify need) |
