...
| 0-12 | Correct SQL Server baseline delete actions + add guarded production reconciliation script | 0 | In Progress | Codex | 2026-06-11 | Production drift reviewed; orphan checks for missing FKs returned zero |
