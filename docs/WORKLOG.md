...
| 3-8 | Club-admin model: global admin grants ClubMembership.Admin; club admins create club competitions | 3 | In Progress | Codex | 2026-07-19 | Implementing global-admin grants and club-admin competition management; clubs remain non-self-claimable |
| 3-9 | Public competition registration: users register for open competitions (and assign rounds) | 3 | Blocked | | 2026-07-19 | Rollout stage 4 (ARCHITECTURE §12.5 3.5). Blocked by staged rollout item 3-8 |
