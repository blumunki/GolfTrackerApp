...
| P-2 | Nav polish: Record Round in the top app bar (web, one tap everywhere) | polish | In Progress | Claude | 2026-06-15 | App-bar CTA in MainLayout. docs/NAVIGATION-IA.md §2 |
