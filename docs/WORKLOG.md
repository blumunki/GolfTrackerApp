...
| 2-4 | Handicap backfill admin action (idempotent, reports n-of-m qualified) | 2 | In Progress | Claude | 2026-06-11 | Unblocked by 2-3. OnRoundCompletedAsync is already idempotent — backfill is iterate + report |
