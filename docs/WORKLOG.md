...
| 3-5 | Web Competitions pages (List/Detail/Create/Results) + links from Society pages + nav | 3 | In Progress | Claude | 2026-06-27 | Unblocked by 3-2. Create gated to global admin + society Owner/Admin (interim); club competitions = global admin only until 3-8. Results: ComputeResultsAsync in service (persists entry results via ScoringCalculator) |
| 3-6 | Round recording: competition selector in setup; assign one of the player's own rounds to a competition they've entered (web) | 3 | Available | | 2026-06-27 | Unblocked by 3-2. RoundType unchanged — CompetitionId is independent of Friendly/Competitive |
