...
| 3-3 | ScoringCalculator — pure scoring formats (Medal net, Stableford points, Match Play result) + TDD tests | 3 | In Progress | Claude | 2026-06-15 | Pure static class (WhsCalculator precedent), reuses StrokesReceivedOnHole. DB orchestration deferred to 3-2/results. ARCHITECTURE §12.5 Phase 3.3 |
