...
| 3-6 | Round recording: competition selector in setup; assign one of the player's own rounds to a competition they've entered (web) | 3 | In Progress | Claude | 2026-06-27 | Unblocked by 3-2. RoundType unchanged — CompetitionId is independent of Friendly/Competitive. Needs GetCompetitionsForPlayerAsync (entered, non-terminal) in service |
