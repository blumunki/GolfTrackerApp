...
| 0-12 | Correct SQL Server baseline delete actions + add guarded production reconciliation script | 0 | In Progress | Codex | 2026-06-11 | Reopened: reconciliation preflight hit Azure SQL catalog/database collation conflict before making changes |
