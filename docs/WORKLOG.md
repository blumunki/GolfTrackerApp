...
| 0-12 | Correct SQL Server baseline delete actions + add guarded production reconciliation script | 0 | Done | Codex | 2026-06-11 | SQL Server uses NO ACTION for unsafe relationships; guarded 64-row reconciliation script added; human production execution remains |
