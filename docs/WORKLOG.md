...
| P-1a | Player Profile hub: consolidate stats + handicap + recent rounds into one per-player page (self + managed); replaces My Stats + My Handicap nav | polish | Blocked | | 2026-06-15 | Awaiting sign-off on docs/NAVIGATION-IA.md §3. UI/nav; engine+API already per-player |
| P-1b | Player-facing nav grouping (Play / My Golf / Directory) via MudNavGroup | polish | Blocked | | 2026-06-15 | Awaiting sign-off on docs/NAVIGATION-IA.md §2 |
| P-1c | Admin dashboard grouping into sections (People / Golf Data / System / AI) | polish | Blocked | | 2026-06-15 | Awaiting sign-off on docs/NAVIGATION-IA.md §6. Makes buried tools (backfill, migrations) findable |
| 2-16 | Handicap transparency: qualifying vs excluded rounds (with reason), best-N-of-window explainer, expectation-setting vs official handicaps | 2 | Blocked | | 2026-06-15 | Awaiting sign-off on docs/NAVIGATION-IA.md §4. Build into whichever page survives P-1a. Supersedes 2-15 |
| 2-17 | WHS v2 adjusted gross = net double bogey (player index-at-date + Hole.StrokeIndex), replacing v1 par+5 | 2 | Blocked | | 2026-06-15 | Awaiting sign-off on docs/NAVIGATION-IA.md §5. Lowers index for established higher handicaps (the 31.5-vs-27 driver). Process oldest-first using running index; par+5 fallback before an index exists; ship with backfill re-run |
