...
| 2-7 | Mobile handicap page (DTOs + API service + dashboard) | 2 | In Progress | Claude | 2026-06-12 | Unblocked by 2-5. Server DTOs in Core/Models/Api/HandicapDtos.cs; mirror with [JsonPropertyName] on mobile per API compat rules |
