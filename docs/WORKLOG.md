...
| 2-6 | Web handicap dashboard (active handicaps, history chart, last-20 differentials) | 2 | Available | | 2026-06-11 | Unblocked by 2-3/2-5. IHandicapService has all needed reads (GetActiveHandicaps, GetHandicapRecords, GetRecentDifferentials) |
