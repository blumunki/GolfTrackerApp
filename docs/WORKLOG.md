...
| 3-7 | Mobile competition models + API service + pages | 3 | Available | | 2026-06-27 | Unblocked by 3-4. Mirror CompetitionDtos with [JsonPropertyName]; on-device test needed |
