...
|----|-----------|-------|--------|-------|---------|-------|
| 0-1 | Create test project + SqliteTestDbFactory + TestDataBuilder + smoke tests | 0 | In Progress | Claude | 2026-06-11 | |
...
| 0-6 | Agent docs (CLAUDE/AGENTS/GEMINI.md, CONTRIBUTING-AGENTS.md, this board) | 0 | In Progress | Claude | 2026-06-11 | |
...
| 0-10 | ARCHITECTURE.md §12 status table + Phase 4 handicap restructure | 0 | In Progress | Claude | 2026-06-11 | |
