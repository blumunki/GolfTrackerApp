...
| 2-12 | HandicapService: fall back to course default tee set when RoundPlayer/Score TeeSetId is null (+ tests) | 2 | In Progress | Claude | 2026-06-15 | Required for historical rounds to qualify in backfill — they all have null TeeSetId. Implements documented "null = default tees" semantics; no round data mutation |
