...
| 3-5 | Web Competitions pages (List/Detail/Create/Results) + links from Society pages + nav | 3 | Available | | 2026-06-27 | Unblocked by 3-2. Create gated to global admin + society Owner/Admin (interim); club competitions = global admin only until 3-8. Results use ScoringCalculator |
