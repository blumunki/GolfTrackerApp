...
| 2-10 | TeeSets.csv import (ratings/slopes) + quick-sync in DataMigration; fix HoleTee.Par=0 on hole import | 2 | Available | | 2026-06-12 | Format per ARCHITECTURE §12.5 (1.4); idempotent upsert by (course, tee name). Holes.csv yardage import already works |
