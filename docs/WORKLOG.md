...
| 3-4 | CompetitionsController (/api/competitions, JWT) — create/manage gated to global admin + society Owner/Admin (interim) | 3 | In Progress | Claude | 2026-06-27 | Unblocked by 3-2. Admin check: User.IsInRole; society role via SocietyMembership. ARCHITECTURE §12.5 3.5 |
