...
| P-1 | Navigation & information-architecture consolidation (epic — needs design direction) | polish | In Progress | Claude | 2026-06-15 | Writing proposal in docs/NAVIGATION-IA.md, then decompose into build items. Admin (13 tiles) + non-admin sprawl; player-profile hub; handicap transparency |
