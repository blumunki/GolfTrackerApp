...
| 3-8 | Club-admin model: global admin grants ClubMembership.Admin; club admins create club competitions | 3 | Available | | 2026-07-19 | Rollout stage 3 (ARCHITECTURE §12.5 3.5). Core 3-2…3-7 is complete. Clubs are shared/real-world; no self-claim |
