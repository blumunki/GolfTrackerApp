...
| P-2 | Nav polish: Record Round in the top app bar (one tap everywhere) + mobile bottom-nav parity (Record Round centre action) | polish | Available | | 2026-06-15 | Follow-up from P-1b/docs/NAVIGATION-IA.md §2. App-bar = MainLayout; mobile = MAUI bottom nav (on-device test needed) |
| P-3 | Profile/handicap/nav review fixes | polish | In Progress | Claude | 2026-06-15 | User review of P-1a/b/c+2-16: (1) Overview tab empty→player home; (2) Stats tab buried under report chrome; (3) transparency denominator counts 9-hole rounds (224 not 20); (4) excluded list needs Club-Course; (5) admin side-nav still flat; (6) players page tiles don't open profiles; (7) connected vs managed handicap inconsistency |
