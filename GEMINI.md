# GolfTrackerApp — Agent Instructions (Gemini)

> Your agent name for WORKLOG ownership is **Gemini**. This file, `CLAUDE.md` (Claude), and `AGENTS.md` (Codex) are identical apart from this paragraph — see Working Agreement rule 6.
