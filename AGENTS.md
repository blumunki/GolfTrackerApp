# GolfTrackerApp — Agent Instructions (Codex)

> Your agent name for WORKLOG ownership is **Codex**. This file, `CLAUDE.md` (Claude), and `GEMINI.md` (Gemini) are identical apart from this paragraph — see Working Agreement rule 6.
