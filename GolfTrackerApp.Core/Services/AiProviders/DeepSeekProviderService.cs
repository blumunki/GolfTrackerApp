...
namespace GolfTrackerApp.Web.Services.AiProviders
{
    ...
    /// </summary>
    public class DeepSeekProviderService : IAiProviderService
    {
        private readonly HttpClient _httpClient;
        private readonly AiProviderConfig _config;
        private readonly ILogger<DeepSeekProviderService> _logger;

        public string ProviderName => _config.Name;

        public DeepSeekProviderService(
            HttpClient httpClient,
            AiProviderConfig config,
            ILogger<DeepSeekProviderService> logger)
        {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                _logger.LogWarning("DeepSeek API error {StatusCode}: {Body}", (int)response.StatusCode, errorBody);
